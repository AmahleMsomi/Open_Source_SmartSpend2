...
import com.example.smartspend.data.model.AppDatabase
import com.example.smartspend.data.model.CategoryDao
import com.example.smartspend.data.model.Expense
import com.example.smartspend.data.model.ExpenseDao
...
class addExpense : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_expense)  // Set the layout for this activity
